...
/** @type {OverlayKeySpec[]} */
const overlayKeys = [
    {label: "F1", code: keyF1, codes: ["F1"], x: 12, y: 8, w: 52, h: 28},
    {label: "F2", code: keyF2, codes: ["F2"], x: 70, y: 8, w: 52, h: 28},
    {label: "F3", code: keyF3, codes: ["F3"], x: 128, y: 8, w: 52, h: 28},
    {label: "F4", code: keyF4, codes: ["F4"], x: 186, y: 8, w: 52, h: 28},
    {label: "F5", code: keyF5, codes: ["F5"], x: 244, y: 8, w: 52, h: 28},

    {label: "ESC", code: keyEscape, codes: ["Escape"], x: 12, y: 42, w: 40, h: 28},
    {label: "1", code: key1, codes: ["Digit1", "Numpad1"], x: 56, y: 42, w: 40, h: 28},
    {label: "2", code: key2, codes: ["Digit2", "Numpad2"], x: 100, y: 42, w: 40, h: 28},
    {label: "3", code: key3, codes: ["Digit3", "Numpad3"], x: 144, y: 42, w: 40, h: 28},
    {label: "4", code: key4, codes: ["Digit4", "Numpad4"], x: 188, y: 42, w: 40, h: 28},
    {label: "5", code: key5, codes: ["Digit5", "Numpad5"], x: 232, y: 42, w: 40, h: 28},
    {label: "6", code: key6, codes: ["Digit6", "Numpad6"], x: 276, y: 42, w: 40, h: 28},
    {label: "7", code: key7, codes: ["Digit7", "Numpad7"], x: 320, y: 42, w: 40, h: 28},
    {label: "8", code: key8, codes: ["Digit8", "Numpad8"], x: 364, y: 42, w: 40, h: 28},
    {label: "9", code: key9, codes: ["Digit9", "Numpad9"], x: 408, y: 42, w: 40, h: 28},
    {label: "0", code: key0, codes: ["Digit0", "Numpad0"], x: 452, y: 42, w: 40, h: 28},
    {label: "-", code: keyMinus, codes: ["Minus", "NumpadSubtract"], x: 496, y: 42, w: 40, h: 28},
    {label: "=", code: keyEqual, codes: ["Equal"], x: 540, y: 42, w: 40, h: 28},
    {label: "\u00A3", code: keyPound, codes: ["Backquote"], x: 584, y: 42, w: 40, h: 28},

    {label: "TAB", code: keyTab, codes: ["Tab"], x: 12, y: 76, w: 48, h: 28},
    {label: "Q", code: letterQ, codes: ["KeyQ"], x: 64, y: 76, w: 40, h: 28},
    {label: "W", code: letterW, codes: ["KeyW"], x: 108, y: 76, w: 40, h: 28},
    {label: "E", code: letterE, codes: ["KeyE"], x: 152, y: 76, w: 40, h: 28},
    {label: "R", code: letterR, codes: ["KeyR"], x: 196, y: 76, w: 40, h: 28},
    {label: "T", code: letterT, codes: ["KeyT"], x: 240, y: 76, w: 40, h: 28},
    {label: "Y", code: letterY, codes: ["KeyY"], x: 284, y: 76, w: 40, h: 28},
    {label: "U", code: letterU, codes: ["KeyU"], x: 328, y: 76, w: 40, h: 28},
    {label: "I", code: letterI, codes: ["KeyI"], x: 372, y: 76, w: 40, h: 28},
    {label: "O", code: letterO, codes: ["KeyO"], x: 416, y: 76, w: 40, h: 28},
    {label: "P", code: letterP, codes: ["KeyP"], x: 460, y: 76, w: 40, h: 28},
    {label: "[", code: keyLBracket, codes: ["BracketLeft"], x: 504, y: 76, w: 40, h: 28},
    {label: "]", code: keyRBracket, codes: ["BracketRight"], x: 548, y: 76, w: 40, h: 28},

    {label: "CAPS", code: keyCapsLock, codes: ["CapsLock"], x: 12, y: 110, w: 56, h: 28},
    {label: "A", code: letterA, codes: ["KeyA"], x: 72, y: 110, w: 40, h: 28},
    {label: "S", code: letterS, codes: ["KeyS"], x: 116, y: 110, w: 40, h: 28},
    {label: "D", code: letterD, codes: ["KeyD"], x: 160, y: 110, w: 40, h: 28},
    {label: "F", code: letterF, codes: ["KeyF"], x: 204, y: 110, w: 40, h: 28},
    {label: "G", code: letterG, codes: ["KeyG"], x: 248, y: 110, w: 40, h: 28},
    {label: "H", code: letterH, codes: ["KeyH"], x: 292, y: 110, w: 40, h: 28},
    {label: "J", code: letterJ, codes: ["KeyJ"], x: 336, y: 110, w: 40, h: 28},
    {label: "K", code: letterK, codes: ["KeyK"], x: 380, y: 110, w: 40, h: 28},
    {label: "L", code: letterL, codes: ["KeyL"], x: 424, y: 110, w: 40, h: 28},
    {label: ";", code: keySemicolon, codes: ["Semicolon"], x: 468, y: 110, w: 40, h: 28},
    {label: "'", code: keyQuote, codes: ["Quote"], x: 512, y: 110, w: 40, h: 28},
    {label: "ENTER", code: keyEnter, codes: ["Enter", "NumpadEnter"], x: 628, y: 76, w: 80, h: 62},

    {label: "SHIFT", code: -1, codes: ["ShiftLeft"], x: 12, y: 144, w: 64, h: 28},
    {label: "\\", code: keyBackslash, codes: ["Backslash"], x: 80, y: 144, w: 40, h: 28},
    {label: "Z", code: letterZ, codes: ["KeyZ"], x: 124, y: 144, w: 40, h: 28},
    {label: "X", code: letterX, codes: ["KeyX"], x: 168, y: 144, w: 40, h: 28},
    {label: "C", code: letterC, codes: ["KeyC"], x: 212, y: 144, w: 40, h: 28},
    {label: "V", code: letterV, codes: ["KeyV"], x: 256, y: 144, w: 40, h: 28},
    {label: "B", code: letterB, codes: ["KeyB"], x: 300, y: 144, w: 40, h: 28},
    {label: "N", code: letterN, codes: ["KeyN"], x: 344, y: 144, w: 40, h: 28},
    {label: "M", code: letterM, codes: ["KeyM"], x: 388, y: 144, w: 40, h: 28},
    {label: ",", code: keyComma, codes: ["Comma"], x: 432, y: 144, w: 40, h: 28},
    {label: ".", code: keyPeriod, codes: ["Period", "NumpadDecimal"], x: 476, y: 144, w: 40, h: 28},
    {label: "/", code: keySlash, codes: ["Slash", "NumpadDivide"], x: 520, y: 144, w: 40, h: 28},
    {label: "SHIFT", code: -1, codes: ["ShiftRight"], x: 564, y: 144, w: 60, h: 28},

    {label: "CTRL", code: -2, codes: ["ControlLeft", "ControlRight"], x: 12, y: 178, w: 56, h: 28},
    {label: "ALT", code: -3, codes: ["AltLeft", "AltRight"], x: 72, y: 178, w: 48, h: 28},
    {label: "SPACE", code: keySpace, codes: ["Space"], x: 124, y: 178, w: 436, h: 28},
    {label: "\u2190", code: keyLeft, codes: ["ArrowLeft"], x: 568, y: 178, w: 36, h: 28},
    {label: "\u2193", code: keyDown, codes: ["ArrowDown"], x: 608, y: 178, w: 36, h: 28},
    {label: "\u2191", code: keyUp, codes: ["ArrowUp"], x: 644, y: 178, w: 36, h: 28},
    {label: "\u2192", code: keyRight, codes: ["ArrowRight"], x: 680, y: 178, w: 28, h: 28},
];
